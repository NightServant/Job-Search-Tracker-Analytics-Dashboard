...
>(
 (
  ...
  // Vendored as-is except for this line: AnimateIcons declares `smoothEase`
  // and never reads it, which fails this repo's `noUnusedLocals`. Commented
  // rather than deleted so a future re-vendor of this icon is a clean diff.
