...
// rounded-full is kept here and allowlisted in shadcnHouseRules.test.ts: the radio dot is a circle.
    ...
    >
      ...
      >
        ...
        <CheckIcon
          ...
          className="hidden size-3.5 [&_svg]:size-3.5 group-data-[type=radio]/questionnaire-choice:hidden group-data-checked/questionnaire-choice:block"
        />
      </span>
