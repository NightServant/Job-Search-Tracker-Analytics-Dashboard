...
function SpellingCard({
  ...
  return (
    <li className="flex flex-col gap-3 border-b border-border-subtle py-4 last:border-b-0">
            ...
            {issue.replacements.map((replacement) => (
              <li key={replacement}>
                <button
                  ...
                  className="border-b border-accent-default text-body-m text-text-primary transition-colors hover:text-accent-default active:scale-[0.99]"
                >
                  {replacement}
                </button>
              </li>
...
export function SpellCheckPane({ state }: { state: ProofreadState }) {
  return (
    <div className="flex flex-col gap-6" data-pane="spelling">
...
export function GrammarCheckPane({ state }: { state: ProofreadState }) {
  ...
  return (
    <div className="flex flex-col gap-6" data-pane="grammar">
