...
export function buildLatexPreviewHtml(latexCode: string, cdnAvailable: boolean): string {
  ...
  return `<!doctype html><html><head><meta charset="UTF-8"/><meta name="viewport" content="width=device-width, initial-scale=1"/>${scriptTag}<style>body{margin:0;padding:1rem;font-family:ui-serif,Georgia,serif;background:#f5f5f5;color:#111827;font-size:14px;line-height:1.6}#root{background:#fff;border:1px solid #e5e7eb;border-radius:4px;padding:1.5rem;min-height:calc(100vh - 2rem);overflow:auto}h1,h2,h3,h4,h5,h6{margin-top:1.25rem;margin-bottom:0.75rem;font-weight:700;color:#000}h1{font-size:1.75rem;margin-top:0}h2{font-size:1.35rem;border-bottom:2px solid #e5e7eb;padding-bottom:0.5rem}h3{font-size:1.15rem}h4{font-size:1rem}p{margin:0.5rem 0}pre{white-space:pre-wrap;word-break:break-word;background:#fafafa;border:1px solid #e5e7eb;border-radius:4px;padding:1rem;font-size:0.9rem;line-height:1.5;font-family:ui-monospace,SFMono-Regular,Menlo,monospace;overflow-x:auto}.error{color:#3f3f46;border-left:2px solid #c2410c;padding:0 0 0 .75rem;margin-bottom:1rem;font-size:0.95rem;font-weight:500}.preview-info{color:#71717a;border-bottom:1px solid #e4e4e7;padding:0 0 .5rem 0;margin:1rem 0 .75rem 0;font-weight:700;font-size:0.75rem;letter-spacing:.06em;text-transform:uppercase}.fallback{font-family:ui-serif,Georgia,serif;font-size:.95rem;line-height:1.7;white-space:pre-wrap;word-break:break-word}ul,ol{list-style-position:outside;margin-left:1.5rem;margin-top:0.5rem;margin-bottom:0.5rem}li{margin:0.25rem 0;line-height:1.6}li > *{display:inline}strong,b{font-weight:700;color:#000}em,i{font-style:italic}a{color:#c2410c;text-decoration:underline}a:hover{color:#9a3412}center{text-align:center}</style></head><body><div id="root"><pre class="fallback">${safeFallbackText}</pre></div><script>${rendererScript}</script></body></html>`
}
